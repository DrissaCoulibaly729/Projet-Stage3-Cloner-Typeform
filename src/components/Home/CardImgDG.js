...
const CardImgDG = () => {
  ...
  return (
    <div className="container mx-auto pt-6 px-6">
      <p className="text-center text-4xl md:text-7xl font-weight-100 py-10 px-4 md:px-[320px] md:p-10 md:m-10">
      ...
      <div className="mb-12">
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start space-y-6 md:space-x-6 md:pt-6 md:pr-6">
          <div className="w-full md:w-1/2 px-6 md:pl-48 md:mt-20">
            ...
            <p className="mt-5 mb-5 text-base md:text-2xl text-gray-700">
